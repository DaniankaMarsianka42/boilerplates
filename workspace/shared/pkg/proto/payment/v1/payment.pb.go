...
const (
	PaymentMethod_CATEGORY_UNKNOWN PaymentMethod = 0
...
func (x *PayRequest) GetUserUuid() string {
	if x != nil {
		return x.UserUuid
	}
	return ""
...
func (x *PayRequest) GetPaymentMethod() PaymentMethod {
	...
	return PaymentMethod_CATEGORY_UNKNOWN
}
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0epayment_method\x18\x03 \x01(\x0e2\x19.payment.v1.PaymentMethodR\rpaymentMethod\"8\n" +
	"\vPayResponse\x12)\n" +
	"\x10transaction_uuid\x18\x01 \x01(\tR\x0ftransactionUuid*]\n" +
	"\rPaymentMethod\x12\x14\n" +
	"\x10CATEGORY_UNKNOWN\x10\x00\x12\b\n" +
	"\x04CARD\x10\x01\x12\a\n" +
	"\x03SBP\x10\x02\x12\x0f\n" +
	"\vCREDIT_CARD\x10\x03\x12\x12\n" +
	"\x0eINVESTOR_MONEY\x10\x042M\n" +
	"\x0ePaymentService\x12;\n" +
	"\bPayOrder\x12\x16.payment.v1.PayRequest\x1a\x17.payment.v1.PayResponseB*Z(../../../pkg/proto/payment/v1;payment_v1b\x06proto3"
...
var file_payment_v1_payment_proto_goTypes = []any{
	...
	(*PayRequest)(nil),  // 1: payment.v1.PayRequest
	(*PayResponse)(nil), // 2: payment.v1.PayResponse
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: payment.v1.PayRequest.payment_method:type_name -> payment.v1.PaymentMethod
	1, // 1: payment.v1.PaymentService.PayOrder:input_type -> payment.v1.PayRequest
	2, // 2: payment.v1.PaymentService.PayOrder:output_type -> payment.v1.PayResponse
