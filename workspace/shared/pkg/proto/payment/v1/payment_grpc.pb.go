...
func (c *paymentServiceClient) PayOrder(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error) {
...
func (UnimplementedPaymentServiceServer) PayOrder(context.Context, *PayRequest) (*PayResponse, error) {
...
func _PaymentService_PayOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).PayOrder(ctx, req.(*PayRequest))
	}
